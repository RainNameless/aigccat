...
ROOT=pathlib.Path(__file__).resolve().parents[2];D=ROOT/'outputs/highquality-10'
labels={'original':'原图生成','multiview':'四视图生成','geometry':'高精度白模 · v3.1','texture':'8K 贴图处理','texture-parts':'8K 贴图处理','rig':'骨骼绑定','rig-v2':'骨骼绑定 · v2','walk':'行走动作','run':'跑步动作','export':'导出模型'}
